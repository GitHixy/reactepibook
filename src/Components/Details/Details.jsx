      ...
      <Row className="mt-2 ">
        <Col className="m-2">
          <Card>
            ...
            <Card.Header as="h6" className="text-muted text-center">
              The ID Code of the book that you've selected is:{" "}
              {bookDetails.asin}
            </Card.Header>
          </Card>
        </Col>
        <Col className="d-flex flex-column align-items-center justify-content-center">
          ...
          {comments.map((comment) => (
            <Card key={comment._id} style={{ width: "25rem" }} className="m-1">
              <Card.Body>
                <Card.Title>
                  User Email: <br></br> {comment.author}
                </Card.Title>
                <hr />
                <Rating
                  value={comment.rate}
                ...
                />
                <Card.Text>
                  <strong>Comment:</strong> <br></br> {comment.comment}
                </Card.Text>
